...
#define shotFocusHold     250    /* Defines how long to hold focus pin high before taking a picture */
#define shotTriggerHold   250    /* Defines how long to hold trigger pin high during photo (non aplicable to Bulb pictures) */
#define shotFocusHoldPost 100    /* Defines how long to hold the focus pin high after taking a picture */
